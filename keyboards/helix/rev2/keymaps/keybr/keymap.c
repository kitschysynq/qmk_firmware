...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT( \
   ...
   KC_MPLY, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC, _______, _______, KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT  \
      ),
  ...
  _______, G(KC_Z),G(KC_X),G(KC_C),A(G(KC_BSLS)), _______,_______, _______, _______, _______, _______, _______, G(KC_SLSH), _______, \
  _______, _______, _______, _______, _______, _______, _______, _______,_______, _______, _______,KC_VOLD, KC_VOLU, KC_MNXT \
      ),
  ...
  [_ADJUST] =  LAYOUT( \
      ...
      _______, _______, _______, _______, _______, _______,                  AG_SWAP, _______,  _______, _______,  _______, _______, \
